...
- Agregar explicación sobre este ejercicio, las evidencias y conclusiones.
  ...
  En este apartado lo que se realizo fue el completamiento de los challenges de comandos relacionados con la terminal de bash; para poder saber los comandos principales de esta terminal y aplicarlos en un entorno necesario.

   conclución: Según nuestra opinión, este tipo de challenges nos sirvio mucho para poder comprender mas sobre los comandos basicos de la terminal de bash y lo utiles que son, puesto que facilitan el realizar las tareas basicas
...
- buscar la información necesaria para la exposición y practicar sobre el tema para hablar fuidamente.
  ...
  En este aparatado nuestro equipo busco la información necesaria para poder comprender el software y hardware de una computadora.

- Aquí estan los links referentes a la información encontrada:
